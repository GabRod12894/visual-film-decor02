...
import { Phone, ArrowRight, CheckCircle, Shield, Star, Clock, Award, Wrench, Eye, Home, Zap, Sun } from "lucide-react"
...
export default function ServicesPage() {
  ...
  <section className="bg-white py-16 lg:py-24 border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-5xl font-serif font-bold text-gray-900 drop-shadow-lg">Nossos Serviços</h1>
            <p className="text-xl text-gray-700 leading-relaxed">
              Soluções completas para transformar sua residência com conforto, segurança e design. Mais de 30 anos de experiência oferecendo qualidade e excelência em cada projeto.
            </p>
  ...
  <section className="py-20 bg-white">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-serif font-bold text-gray-900 mb-14 text-center drop-shadow-lg tracking-tight">
            Serviços Oferecidos
          </h2>
